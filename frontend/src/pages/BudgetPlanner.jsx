...
const STYLES = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .bp-hero h1{font-family:'Fraunces',serif;font-size:clamp(2rem,5vw,3.2rem);font-weight:700;color:#fff;margin:0 0 12px;line-height:1.1;letter-spacing:-0.02em;}
  ...
  .bp-card-title{font-family:'Fraunces',serif;font-size:1.1rem;font-weight:700;color:#0a2818;}
  ...
  .bp-input,.bp-select{width:100%;padding:10px 14px;border:1.5px solid #d1fae5;border-radius:10px;font-size:0.9rem;font-family:'DM Sans',sans-serif;color:#0f172a;outline:none;background:#fff;transition:border 0.15s;}
  ...
  .bp-add-btn{background:none;border:1.5px dashed #d1fae5;border-radius:10px;padding:10px 20px;color:#16a34a;font-size:0.875rem;font-weight:600;cursor:pointer;font-family:'DM Sans',sans-serif;width:100%;margin-top:8px;transition:all 0.15s;}
  .bp-add-btn:hover{background:#f0fdf4;border-style:solid;}
  .bp-calc-btn{width:100%;padding:15px;background:#16a34a;color:#fff;border:none;border-radius:12px;font-size:1rem;font-weight:700;cursor:pointer;font-family:'DM Sans',sans-serif;transition:all 0.2s;margin-top:8px;}
  ...
  .bp-results-title{font-family:'Fraunces',serif;font-size:1.3rem;font-weight:700;color:#fff;margin-bottom:24px;}
  ...
  .bp-res-val{font-family:'Fraunces',serif;font-size:1.3rem;font-weight:700;color:#4ade80;}
  ...
  .bp-total-val{font-family:'Fraunces',serif;font-size:2.2rem;font-weight:700;color:#fff;}
